    ...
    <div className="w-full bg-primary-bg py-10 px-5">
      <div className="md:container mx-auto ">
        ...
        <div className="grid  grid-cols-1 md:grid-cols-3 gap-10 py-10 px-5 md:px-0  ">
          <div className={` col py-7 px-5 bg-white shadow-lg rounded-lg group hover:shadow-2xl hover:scale-[1.04] transition duration-300 ease-in-out`}>
            <img
              src="./images/ux-design.png"
              className="max-h-20 "
              alt="ux image"
            />
            <p className="text-xl font-bold text-primary-darker py-3 group-hover:text-primary">
          ...
          <div className={` col py-7 px-5 bg-white shadow-xl rounded-lg group hover:shadow-2xl hover:scale-[1.04] transition duration-300 ease-in-out`}>
            <img
        ...
        <div className="grid  grid-cols-1 md:grid-cols-3 gap-5 py-10 px-5 md:px-0  ">
            <div className="col text-center pb-5 border-b-2 border-primary-light md:border-b-0  md:border-r-2 ">
                ...
                <h1 className="text-xl text-neutral-600 font-semibold">Experience</h1>
            </div>
            <div className="col text-center pb-5 border-b-2 border-primary-light md:border-b-0  md:border-r-2 ">
                <h1 className="text-4xl text-primary font-extrabold">5</h1>
                <h1 className="text-xl text-neutral-600 font-semibold">Projects Compoleted</h1>
            </div>
            <div className="col text-center">
                <h1 className="text-4xl text-primary font-extrabold">3</h1>
                <h1 className="text-xl text-neutral-600 font-semibold">Happy Clients</h1>
            </div>
        </div>
      </div>
    </div>
